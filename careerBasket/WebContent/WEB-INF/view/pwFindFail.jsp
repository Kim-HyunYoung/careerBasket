...
<body>
	...
	<div class="all">
		...
		<div id="bottom">
			<h2>정보를 다시 확인 후 </h2> <br>
			<h2>입력해주세요.</h2> <br>
			<button class="findButton"><a href="/user/findPwForm">비밀번호 다시 찾기</a></button>
		</div>
	</div>
</body>
</html>