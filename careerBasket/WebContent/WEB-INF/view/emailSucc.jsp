...
<link rel="stylesheet" type="text/css" href="/css/emailSucc.css">
...
<body>
	...
	<div class="all">
		...
		<div id="bottom">
			...
			<button class="bt"><a href="/user/loginForm">로그인 하기</a></button> <br>
			
			<form action="/user/changePwForm" method="get">
				<input type="hidden" name="email" value="${email}">
				<input type="hidden" name="name" value="${name}"> 
				<input type="hidden" name="userId" value="${userId}"> 
				<input class="change" type="submit" value="비밀번호 변경하기">
			</form>
		</div>
	</div>
</body>
