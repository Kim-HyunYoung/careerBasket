...
<body>
	...
	<div class="all">
		...
		<div id="bottom">
			<h2>입력하신 정보를</h2> <br> 
			<h2>다시 확인해주세요.</h2> <br>
			<button class="findButton"><a href="/user/findIdForm">아이디 다시 찾기</a></button> <br>
		</div>
	</div>
</body>
</html>